...
class GameManager {
    ...
    void update() {
        if (showLoadingScreen && loadingManager.isLoading()) { loadingManager.update(); return; }
...
class ThingManager {
    ...
    void clearAll() {
      this.things.clear();
      this.mainHumans.clear();
      this.trackedHuman = null;
    }
...
class LoadingManager {
    ...
    LoadingManager(GameManager gameManager) {
        ...
        loadingTips = new String[] {
            "You can change loading tips by changing the array loadingTips!"
        };
